							...
							<div class="accordion" id="accordion" style="margin-top:1%;">
								...
								<?php
									...
									while($row = mysqli_fetch_array($result)) 
									{
										...
										if($course == "Cross-Site Request Forgery (CSRF)") //WYCIAGNIJ KURS CSRF I DLA KAZDEGO TEMATU WYGENERUJ DANE
										{
											echo'
									...
									if(isset($_POST["load1"])){ 
										$_SESSION["lab"] = "Labs\csrf_lab\csrf1.php"; 								
										$_SESSION['csrf'] = "NO";
										$_SESSION['csrflogin'] = "";
										...
										$file = fopen( 'csrf_exploit.html', 'w' );
										fclose($file);

									} //USTAWIENIE LABORATORIUM NA WYBRANE PRZEZ USERA 
									if(isset($_POST["load2"])){ 
										$_SESSION["lab"] = "Labs\csrf_lab\csrf2.php";
									...
									if(isset($_POST["load3"])) {$_SESSION["lab"] = "Labs\csrf_lab\csrf3.php";}
									if(isset($_POST["load4"])) {$_SESSION["lab"] = "Labs\csrf_lab\csrf4.php";}
									if(isset($_POST["load5"])) {$_SESSION["lab"] = "Labs\csrf_lab\csrf5.php";}
									if(isset($_POST["load6"])) {$_SESSION["lab"] = "Labs\csrf_lab\csrf6.php";}
									if(isset($_POST["load1"]) OR isset($_POST["load2"]) OR isset($_POST["load3"]) OR isset($_POST["load4"]) OR isset($_POST["load5"]) OR isset($_POST["load6"]) )
									{
