							...
							<div class="accordion" id="accordion" style="margin-top:1%;">
								...
								<?php
									...
									while($row = mysqli_fetch_array($result)) 
									{
										...
										if($course == "Brute Force") //WYCIAGNIJ KURS CSRF I DLA KAZDEGO TEMATU WYGENERUJ DANE
										{
											echo'
											<div class=" card  border-0" style="margin-bottom:0.8%; border-radius:0;"> 
												...
												<div id="collapse'.$counter.'" class="collapse content'.$counter.' border-0" aria-labelledby="heading'.$counter.'" data-parent="#accordion"  !important" style="background-color:#d1ff52;  background-image: linear-gradient(#868e96 10%, rgba(134,142,150,0.6), #bbe053 );" >
													...
													<div class=" text-justify lab_content border-dark" style="font-size:80%; padding:2%;">
														'.$content.'';
														if($course_title == "Lab 1 - Username enumeration via different responses"){
														echo'<br>Use these dictionaries for:<br>
														<textarea type="textarea" value="" id="logindict">
0000 
qazwsx 
123qwe 
killer 
...
hockey 
ranger</textarea><br>
														<button onclick=\'copyDict("logindict")\'>Copy logins</button><br><br>
														<textarea type="textarea" value="" id="passdict">
23456789
12345
1234
111111
...
654321
superman
1qaz2wsx</textarea><br>
														<button onclick=\'copyDict("passdict")\'>Copy passwords</button><br>
									...
									if(isset($_POST["load24"])){ 
										$_SESSION["lab"] = "Labs\brute_lab\brute1.php";
										$_SESSION['sqli'] = "NO";
										$_SESSION['sqlilogin'] = "";
									}
									
									if(isset($_POST["load25"])) {
										$_SESSION["lab"] = "Labs\brute_lab\brute3.php";
										$_SESSION['sqli'] = "NO";
										$_SESSION['sqlilogin'] = "";

									}
									if(isset($_POST["load26"])) {
										$_SESSION["lab"] = "Labs\brute_lab\brute3.php";
										$_SESSION['sqli'] = "NO";
										$_SESSION['sqlilogin'] = "";
									...
									if(isset($_POST["load13"]) OR isset($_POST["load14"]) OR isset($_POST["load15"]) )
									{
							...
							<script>
									function copyDict(x) {
										...
										setTimeout(function(){ toastr.info("Dictionary copied to the clipboard");; }, 500);
