...
<div class="col-sm-12 " id="labcore" style="border-radius:10px;  background: rgba(134,142,150,0.6);">
	...
	<div class="row"><h4 style="color: #d1ff52; margin:auto; margin-top:3%;">XSS LAB 5</h4></div>
	...
	<div class="row" style=" padding:2%; height:100%;">
		<div class="col-4">
					...
					<h6 style="color: #d1ff52;">Post comment</h6>
						<form method="POST" action="/lab">
							<div style="margin-bottom:5%; margin-top:5%;">
								<input id = "comm" class="form-control" placeholder="comment" type="text" name="comment" required>	
							</div>
						...
						<?php
							...
							if(isset($_POST["complete"])) 
							{
								if(TRUE) // JEŚLI KRYTERIA UKOŃCZENIA LAB ZOSTANĄ WYKONANE TO ZUPADTUJ DB ORAZ ODLACZ BATERIE Z LABORATORIUM
								{
									...
									$sql = "UPDATE course_content SET status='YES' WHERE (course_content.course_ID = 2 AND course_content.title = 'Lab 5 - Stored DOM XSS') AND (course_content.user_ID = $id) "; // ZMIENIC TITLE NA WYNIK SELECTA Z BAZY DANYCH
			...
			<div class="card bg-dark d-none" id="congratulation" style="margin-bottom:7%; margin-top:10%;  "> 
					<div class="card-body " style="padding-bottom:10%; padding-top:5%;">
						<h4 id="result"  style="color:#b1de35;"> Congratulation you completed the lab! Commit solution to save changes!! </h4> <!-- finished lab info -->
					</div>
			</div>
				...
				<div class="card-body " style="padding-bottom:10%; padding-top:5%;">
					...
					?>
						...
						?>
							<?php $idcom = $r["ID"]; ?>							
								<div class="card " style=" margin-bottom:2%; background-color: #d1ff52; font-size:80%; ">
									...
									<div class="card-body" style="padding:1%; padding-left:2%; padding-bottom:0%;">
										<p id="<?php echo $idcom ?>" class="card-text text-dark"></p>
							...
							?>
							document.getElementById("<?php echo $idcom ?>").innerHTML = stripHtml('<?php echo $subject ?>'); 
