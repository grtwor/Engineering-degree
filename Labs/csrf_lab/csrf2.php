...
<div class="col-sm-12" id="labcore" style="border-radius:10px; background: rgba(134,142,150,0.6);">
	...
	<div class="row"><h4 style="color: #d1ff52; margin:auto; margin-top:3%;">CSRF LAB 2</h4></div>
			...
			<?php 
				...
				if ($_SESSION['csrf'] == "logged")
				{
							...
							<div class="card-body " style="padding-bottom:10%; padding-top:10%;">
								...
								<form method="POST" action="lab" name="changemailform">
									<div style="margin-bottom:5%; margin-top:5%;">
										...
										<input id="csrftoken" required type="hidden" name="csrftoken" value="7Q3oH72KbiPDI9U7o8RtHyHenVG42UD0"> 
									</div>
					...
					{ 
						...
						if(($_POST['csrftoken'] == "7Q3oH72KbiPDI9U7o8RtHyHenVG42UD0") OR  (is_null($_POST['csrftoken'])) ){
			...
			<?php
				...
				if(isset($_POST["complete"]))
				{
					if(TRUE) // JEŚLI KRYTERIA UKOŃCZENIA LAB ZOSTANĄ WYKONANE TO ZUPADTUJ DB ORAZ ODLACZ BATERIE Z LABORATORIUM
					{
						...
						$sql = "UPDATE course_content SET status='YES' WHERE (course_content.course_ID = 1 AND course_content.title = 'Lab 2 - CSRF where token validation depends on token being present') AND (course_content.user_ID = $id) "; // ZMIENIC TITLE NA WYNIK SELECTA Z BAZY DANYCH
