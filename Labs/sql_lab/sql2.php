...
<div  class="col-sm-12" id="labcore" style="border-radius:10px; background: rgba(134,142,150,0.6);  margin-bottom:5%;">
	...
	<div class="row"><h4 style="color: #d1ff52; margin:auto; margin-top:3%; margin-bottom:3%;">SQL LAB 2</h4>
	...
	<div class="row" style="height:500px !important; padding:3%;">
		<div class="col-12">
			...
			<?php 
				...
				{
					echo"<div class='row justify-content-center' style='margin:auto; color:#b1de35;'><h1>Welcome back admin!</h1></div>";
					echo'
					<script>
					...
					$sql = "UPDATE course_content SET status='YES' WHERE (course_content.course_ID = 3 AND course_content.title = 'Lab 2 - SQL injection vulnerability allowing login bypass') AND (course_content.user_ID = $id) "; // ZMIENIC TITLE NA WYNIK SELECTA Z BAZY DANYCH
