...
<div  class="col-sm-12" id="labcore" style="border-radius:10px; background: rgba(134,142,150,0.6); ">
	...
	<div class="row"><h4 style="color: #d1ff52; margin:auto; margin-top:3%; margin-bottom:3%;">SQL LAB 3</h4></div>
					...
					if(( $_SESSION['sqli'] == "NO")){
						...
						if ($_SESSION['sqli'] == "logged")
						{
							...
							if($_SESSION['sqlilogin'] == "admin"){
								$sql = "UPDATE course_content SET status='YES' WHERE (course_content.course_ID = 3 AND course_content.title = 'Lab 3 -  SQL injection UNION attack, retrieving data from other tables') AND (course_content.user_ID = $id) "; // ZMIENIC TITLE NA WYNIK SELECTA Z BAZY DANYCH
